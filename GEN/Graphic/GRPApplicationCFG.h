...
public:
		...
		void														GetResolution(XDWORD* rx, XDWORD* ry) { *rx = screenresolutionx;	*ry = screenresolutiony; }
		void														GetScreenPosition(XDWORD* px, XDWORD *py) { *px = screenpositionx;		*py = screenpositiony; }
		...
		{
				xdebugtarget[0].Format(__L("%d,%s"), XDEBUGCTRLTYPE_NET, XDEBUG_DEFAULT_NETAIM);
