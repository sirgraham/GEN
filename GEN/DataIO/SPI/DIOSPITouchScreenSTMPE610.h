...
#define DIOSPITOUCHSCREENSTMPE610_REG_TSC_CTRL						0x40  //	4-wire touch screen controller setup
#define DIOSPITOUCHSCREENSTMPE610_REG_TSC_CFG							0x41  //	Touch screen controller configuration
...
#define DIOSPITOUCHSCREENSTMPE610_REG_TSC_DATA_X					0x4D  //	Data port for touch screen controller data access
#define DIOSPITOUCHSCREENSTMPE610_REG_TSC_DATA_Y					0x4F  //	Data port for touch screen controller data access
#define DIOSPITOUCHSCREENSTMPE610_REG_TSC_DATA_Z					0x51  //	Data port for touch screen controller data access
#define DIOSPITOUCHSCREENSTMPE610_REG_TSC_DATA_XYZ				0x52  //	Data port for touch screen controller data access
#define DIOSPITOUCHSCREENSTMPE610_REG_TSC_FRACT_XYZ				0x56  //	Select the range and accuracy of the pressure measurement
#define DIOSPITOUCHSCREENSTMPE610_REG_TSC_DATA						0x57  //	Data port for touch screen controller data access
#define DIOSPITOUCHSCREENSTMPE610_REG_TSC_I_DRIVE					0x58  //	Touch screen controller drive I
#define DIOSPITOUCHSCREENSTMPE610_REG_TSC_SHIELD					0x59  //	Touch screen controller shield
