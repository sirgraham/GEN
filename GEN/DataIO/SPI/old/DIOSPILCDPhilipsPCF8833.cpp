...
bool DIOSPILCDSCREENPHILIPSPCF8833::Clear(XWORD color)
{
  ...
  DIOSPILCDSCREENPHILIPSPCF8833_SENDCOMMAND(DIOSPILCDSCREENPHILIPSPCF8833_PASET);
  DIOSPILCDSCREENPHILIPSPCF8833_SENDDATA(0);
  DIOSPILCDSCREENPHILIPSPCF8833_SENDDATA(width-1);

  DIOSPILCDSCREENPHILIPSPCF8833_SENDCOMMAND(DIOSPILCDSCREENPHILIPSPCF8833_CASET);
  DIOSPILCDSCREENPHILIPSPCF8833_SENDDATA(0);
  DIOSPILCDSCREENPHILIPSPCF8833_SENDDATA(height-1);

  DIOSPILCDSCREENPHILIPSPCF8833_SENDCOMMAND(DIOSPILCDSCREENPHILIPSPCF8833_RAMWR);
  ...
  for(int c=0; c<(width * height); c++)
    {
      DIOSPILCDSCREENPHILIPSPCF8833_SENDDATA(bcolor[0]);
      DIOSPILCDSCREENPHILIPSPCF8833_SENDDATA(bcolor[1]);
    }
...
bool DIOSPILCDSCREENPHILIPSPCF8833::Update(XBYTE* buffer)
{
  ...
  for(int c=0; c<(width * height); c++)
    {
      DIOSPILCDSCREENPHILIPSPCF8833_SENDDATA(buffer[d+1]);
      DIOSPILCDSCREENPHILIPSPCF8833_SENDDATA(buffer[d]);
      d+=2;
    }
...
bool DIOSPILCDSCREENPHILIPSPCF8833::LCD_Init()
{
  ...
  DIOSPILCDSCREENPHILIPSPCF8833_SENDCOMMAND(DIOSPILCDSCREENPHILIPSPCF8833_SLEEPOUT);
  DIOSPILCDSCREENPHILIPSPCF8833_SENDCOMMAND(DIOSPILCDSCREENPHILIPSPCF8833_INVOFF);
  DIOSPILCDSCREENPHILIPSPCF8833_SENDCOMMAND(DIOSPILCDSCREENPHILIPSPCF8833_COLMOD);
  DIOSPILCDSCREENPHILIPSPCF8833_SENDDATA(0x05);

  DIOSPILCDSCREENPHILIPSPCF8833_SENDCOMMAND(DIOSPILCDSCREENPHILIPSPCF8833_MADCTL);
  DIOSPILCDSCREENPHILIPSPCF8833_SENDDATA(0x00);
  DIOSPILCDSCREENPHILIPSPCF8833_SENDCOMMAND(DIOSPILCDSCREENPHILIPSPCF8833_SETCON);
  DIOSPILCDSCREENPHILIPSPCF8833_SENDDATA(0x3B);
  DIOSPILCDSCREENPHILIPSPCF8833_SENDCOMMAND(DIOSPILCDSCREENPHILIPSPCF8833_TEOFF);
  ...
  DIOSPILCDSCREENPHILIPSPCF8833_SENDCOMMAND(DIOSPILCDSCREENPHILIPSPCF8833_DISPON);
...
bool DIOSPILCDSCREENPHILIPSPCF8833::Buffer_AdjustWithNOP()
{
  ...
  DIOSPILCDSCREENPHILIPSPCF8833_SENDCOMMAND(DIOSPILCDSCREENPHILIPSPCF8833_NOP);
