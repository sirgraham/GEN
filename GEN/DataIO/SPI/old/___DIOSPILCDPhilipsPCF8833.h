...
#define DIOSPILCDSCREENPHILIPSPCF8833_COMMAND(command)						databuffer->AddNBits((XWORD)(command & ~0x100))		
#define DIOSPILCDSCREENPHILIPSPCF8833_DATA(data)									databuffer->AddNBits((XWORD)(data    |  0x100))			
