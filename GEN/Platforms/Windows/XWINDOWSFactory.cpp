...
CREATEFUNC(XWINDOWSFACTORY, XSHAREDMEMORY   , XWINDOWSSHAREDMEMORY     , Create_SharedMemory)
DELETEFUNC(XWINDOWSFACTORY, XSHAREDMEMORY   , XWINDOWSSHAREDMEMORY     , Delete_SharedMemory)